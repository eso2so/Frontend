let movieList = [
    { id: 1, title: "어벤저스", director: 1 },
    { id: 2, title: "블랙펜서2", director: 2 },
];
...
// Promise를 반환하는 함수를 중첩해서 사용하면 복잡하다.
searchTitle("어벤저스")
    .then(function (res) {
...
async function render(title) {
    try {
        ...
        document.querySelector(".director").innerHTML = director.name;
